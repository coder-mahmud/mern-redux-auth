...
const Hero = () => {
 ...
 <div className="hero max-w-7xl mx-auto px-4">
      <div className="max-w-3xl bg-slate-300 mx-auto border rounded-md mt-10 md:mt-20 p-4 md:p-16">
        ...
        <p className='text-lg text-center'>This MERN(MongoDB, Express, React, NodeJS) app is using Redux Toolkit and RTK Query to manage app label states and REST API queries. On top of that, it is using Tailwind CSS. Please register and login to see it in action.</p>
